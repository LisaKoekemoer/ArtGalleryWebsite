...
import gridOne from '../images/desktop/image-grid-1.jpg';
import gridTwo from '../images/desktop/image-grid-2.jpg';
import gridThree from '../images/desktop/image-grid-3.jpg';
    ...
    <div>
      <header>
        <div className='logo-container'>
            <img className='dark' src={logoDark} alt="" />
            <img className='light' src={logoLight} alt="" />
        </div>
        ...
        <div className='CTA'>
            <p>The arts in the collection of the Modern Art Gallery
              ...
              <nav>
                <Link to='/location' className='btn-location'>
                  <label className='location' htmlFor="button">OUR LOCATION</label>
                  <abbr className='rightArrow' title="arrow"><img src={arrowRight} alt="" /></abbr>
                </Link>
              </nav>
        </div>
      </header>
      ...
      <div className='section2'>
        ...
        <div className='item4'>
          <img src={gridThree} alt="" />
        </div>
        <div className='item5'>
          <h2>COME & BE INSPIRED</h2>
          <p>We’re excited to welcome you to our gallery and see 
      ...
      <footer>
        <div className='footer-content'>
          ...
          <p>The Modern Art Gallery is free to all visitors and open 
