        ...
        <div className='map'>
          <nav>
            <Link to="/" className='btn-home'>
              <abbr className='leftArrow' title="arrow"><img src={arrowLeft} alt="" /></abbr>
              <label className='home' htmlFor="button">BACK TO HOME</label>
            </Link>
          </nav>
        </div> 
        ...
        <div className='ourLocation-container'>
          <div className='ourLocation-content'>
            ...
            <div className='addressInfo'>
                <h3 className='streetAddress'>99 KING STREET</h3>
                <p className='suburb'>Newport <br /> 
                  RI 02840 <br />
                  United States of America
                </p>
                <p className='locationInfo'>Our newly opened gallery is located near the Edward King 
